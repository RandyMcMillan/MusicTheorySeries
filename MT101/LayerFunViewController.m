...
- (void)viewDidLoad {
    ...
    self.view.layer.frame = CGRectMake (20,20,GRANDSTAFFEXAMPLEWIDTH-40,GRANDSTAFFEXAMPLEHEIGHT-100);
...
void BYPASSMyDrawColoredPattern (void *info, CGContextRef context) {
...
- (void)drawLayer:(CALayer *)layer inContext:(CGContextRef)context {
    ...
    static const CGPatternCallbacks callbacks = { 0, &BYPASSMyDrawColoredPattern, NULL };
