(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+dot+re+dot+mi+'</center></br><center>'+message3+'</center></br><center>'+mi+dot+re+dot+doe+dot+ti+dot+la+dot+sol+dot+fa+dot+mi+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.Phrygian = new Ext.Panel({
      id:'Phrygian',

								   cls: 'card card1',
								   scroll: '',
								   html: '<p><img class="example" src="resources/scaleSVGs/Phrygian.svg" left="0" top="0"/></p>',
