 (function() {
  ...
  this.popup = new Ext.Panel({
                             ...
                             styleHtmlContent: true,
                             html: '<p><center><span class="do">Do</span><span class="dot">•</span><span class="re">Re</span><span class="dot">•</span><span class="mi">Mi</span><span class="dot">•</span> <span class="fa">Fa</span><span class="dot">•</span><span class="sol">Sol</span><span class="dot">•</span><span class="la">La</span><span class="dot">•</span><span class="ti">Ti</span><span class="dot">•</span> <span class="do">Do</span></center></p><center>Practice visualizing each color while singing each tone.</center>',
                             //dockedItems: [{
                             //            dock: 'top',
                             //          xtype: 'toolbar',
                             //        title: 'Overlay Title'
  ...
  demos.Sharps = new Ext.Panel({
                              id:'Sharps',
                              
                              cls: 'card card1',
                              scroll: '',
                              html: '<p><img class="example" src="resources/scaleSVGs/Sharps.svg" left="0" top="0"/></p>',
