(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+la+dot+doe+dot+mi+dot+sol+dot+ti+dot+re+dot+fa+dot+la+'</center></br><center>'+message2+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.MinorScale = new Ext.Panel({
      id:'MinorScale',

								   cls: 'card card1',
								   scroll: '',
								   html: '<p><img class="example" src="resources/scaleSVGs/MinorScale.svg" left="0" top="0"/></p>',
