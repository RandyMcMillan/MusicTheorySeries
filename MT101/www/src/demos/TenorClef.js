(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+re+dot+fa+dot+la+dot+doe+dot+re+dot+mi+dot+fa+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 demos.TenorClef = new Ext.Panel({
                                   id: 'TenorClef',
                                   cls: 'card card1',
                                   html: '<p><img class="example" src="resources/scaleSVGs/TenorClef.svg" left="0" top="0"/></p>',
