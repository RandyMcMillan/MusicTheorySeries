(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+fa+dot+sol+dot+la+dot+ti+dot+doe+dot+re+dot+mi+dot+fa+'</center></br><center>'+message1+'</center></br><center>'+fa+dot+mi+dot+re+dot+doe+dot+ti+dot+la+dot+sol+dot+fa+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.Lydian = new Ext.Panel({
      id:'Lydian',

								   cls: 'card card1',
								   scroll: '',
								   html: '<p><img class="example" src="resources/scaleSVGs/Lydian.svg" left="0" top="0"/></p>',
