(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+dot+re+'</center></br><center>'+message3+'</center></br><center>'+re+dot+doe+dot+ti+dot+la+dot+sol+dot+fa+dot+mi+dot+re+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.Dorian = new Ext.Panel({
      id:'Dorian',

								 cls: 'card card1',
								 scroll: '',
								 html: '<p><img class="example" src="resources/scaleSVGs/Dorian.svg" left="0" top="0"/></p>',
