(function() {
 ...
 wikiString = "Clef#Subbass_clef.E2.80.A0";
 if (!Ext.is.Desktop) {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+dot+re+dot+mi+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.SubBassClef = new Ext.Panel({
                                 id: 'SubBassClef',
                                 cls: 'card card1',
                                 html: '<p><img class="example" src="resources/scaleSVGs/SubBassClef.svg" left="0" top="0"/></p>',
