(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+doe+dot+me+dot+fa+dot+se+dot+sol+dot+te+dot+doe+'</center></br><center>'+message1+'</center></br><center>'+me+dot+fa+dot+se+dot+sol+dot+te+dot+doe+dot+me+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+doe+dot+me+dot+fa+dot+se+dot+sol+dot+te+dot+doe+'</center></br><center>'+message1+'</center></br><center>'+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+dot+ti+dot+re+dot+mi+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.BluesScale = new Ext.Panel({
      id:'BluesScale',

								 cls: 'card card1',
								 scroll: 'verticle',
								 html: '<p><img class="example" src="resources/scaleSVGs/BluesScale.svg" left="0" top="0"/></p>',
