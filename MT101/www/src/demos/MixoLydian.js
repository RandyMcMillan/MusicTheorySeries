(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+sol+dot+la+dot+ti+dot+doe+dot+re+dot+mi+dot+fa+dot+sol+'</center></br><center>'+message1+'</center></br><center>'+sol+dot+fa+dot+mi+dot+re+dot+doe+dot+ti+dot+la+dot+sol+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.MixoLydian = new Ext.Panel({
      id:'MixoLydian',

								   cls: 'card card1',
								   scroll: '',
								   html: '<p><img class="example" src="resources/scaleSVGs/MixoLydian.svg" left="0" top="0"/></p>',
