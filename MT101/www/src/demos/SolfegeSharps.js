(function() {
 ...
 var dockedItems = [new Ext.Toolbar({
     ...
     if (!Ext.is.Phone) {
         ...
         demos.SolfegeSharps = new Ext.Panel({
             id:'SolfegeSharps',
             cls: 'card card1',
             scroll: '',
             html: '<p><img class="solfege" src="resources/scaleSVGs/TrebleClefSolfegeSharps.svg" left="0" top="0"/><span class="do">Do</span> <span class="di"> • </span> <span class="re">Re</span> <span class="ri"> • </span> <span class="mi">Mi </span> <span class="fa">Fa</span> <span class="fi"> • </span> <span class="sol">Sol</span> <span class="si"> • </span> <span class="la">La</span> <span class="li"> • </span> <span class="ti">Ti</span> <span class="do">Do</span><img class="solfege" src="resources/scaleSVGs/BassClefSolfegeSharps.svg" left="0" top="0"/><span class="mi">Mi</span> <span class="fa">Fa</span> <span class="fi"> • </span> <span class="sol">Sol</span> <span class="si"> • </span> <span class="la">La</span> <span class="li"> • </span> <span class="ti">Ti</span> <span class="do">Do</span><span class="di"> • </span> <span class="re">Re</span> <span class="ri"> • </span> <span class="mi">Mi </span></p>',
