(function() {
 ...
 wikiString = "Clef#Baritone_clef.E2.80.A0";
 if (!Ext.is.Desktop) {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+ti+dot+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.BariToneClef = new Ext.Panel({
                                  id: 'BariToneClef',
                                  cls: 'card card1',
                                  html: '<p><img class="example" src="resources/scaleSVGs/BariToneClef.svg" left="0" top="0"/></p>',
