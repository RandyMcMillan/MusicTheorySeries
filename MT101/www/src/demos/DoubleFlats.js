(function() {
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.DoubleFlats = new Ext.Panel({
      id:'DoubleFlats',

								 cls: 'card card1',
								 scroll: 'verticle',
								 html: '<p><img class="example" src="resources/scaleSVGs/DouvleFlats.svg" left="0" top="0"/><span class="do">Do</span> <span class="di">Di</span> <span class="re">Re</span> <span class="ri">Ri</span> <span class="mi">Mi</span> <span class="fa">Fa</span> <span class="fi">Fi</span> <span class="sol">Sol</span> <span class="si">Si</span> <span class="la">La</span> <span class="li">Li</span> <span class="ti">Ti</span> <span class="do">Do</span></p>',
