(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+'</center></br><center>'+message3+'</center></br><center>'+doe+dot+ti+dot+la+dot+sol+dot+fa+dot+mi+dot+re+dot+doe+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.Ionian = new Ext.Panel({
      							   id:'Ionian',
								   cls: 'card card1',
								   scroll: '',
								   html: '<p><img class="example" src="resources/scaleSVGs/Ionian.svg" left="0" top="0"/></p>',
