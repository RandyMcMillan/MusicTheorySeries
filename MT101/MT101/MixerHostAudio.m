...
- (void)obtainSoundFileURLs
{
    for (int i = 0; i < FILE_COUNT; i++) {
        if (i == 0) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C2"] withExtension:@"L.aif"];
        ...
        if (i == 1) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C#2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 2) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 3) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D#2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 4) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"E2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 5) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 6) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F#2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 7) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"G2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 8) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"G#2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 9) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"A2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 10) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"A#2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 11) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"B2"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 12) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 13) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C#3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 14) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 15) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D#3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 16) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"E3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 17) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 18) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F#3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 19) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"G3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 20) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"G#3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 21) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"A3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 22) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"A#3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 23) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"B3"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 24) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 25) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C#4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 26) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 27) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D#4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 28) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"E4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 29) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 30) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F#4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 31) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"G4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 32) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"G#4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 33) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"A4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 34) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"A#4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 35) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"B4"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 36) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C5"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 37) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C#5"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 38) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D5"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 39) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D#5"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 40) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"E5"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 41) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F5"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 42) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"F#5"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i == 49) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"C#6"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
        ...
        if (i > 49) {
            NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"D6"] withExtension:@"L.aif"];
            sourceURLArray[i] = (CFURLRef) [url retain];
