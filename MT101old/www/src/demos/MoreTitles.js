(function() {
 ...
 var onAppStore = function(button, event) {
 if (!Ext.is.Desktop) {
window.location = "http://itunes.apple.com/us/app/music-theory-101/id322256596?mt=8";
 }
 else {
 if (!this.popup) {
 this.popup = new Ext.Panel({html:''});
 this.popup = new Ext.Panel({
                            ...
                            //cls:'Wiki',
                            styleHtmlContent: true,
                            html: '<p><iframe frameborder="0" SRC="http://itunes.apple.com/us/app/music-theory-101/id322256596?mt=8" width=" ' + moreWidth + ' " height=" ' + moreHeight + ' "></iframe></p>',
 ...
 var buttonsGroup2 = [{
                      ...
                      items: [{
                              text: 'In the iTunes App Store',
                              handler: onAppStore,allowDepress: false,
                              hidden:false,
                              }]
                      }];
 ...
 var dockedItems = [new Ext.Toolbar({
    ...
    demos.MoreTitles = new Ext.Panel({
        id:'MoreTitles',
        cls: 'card card1',
        scroll: '',
        html: '<p><div class="moreTitles"><img src="resources/img/MT102Logo.png" width="211" height="211"/><h1>Music Theory 102</h1></div></p>',
