(function() {
 ...
 wikiString = "Clef#Soprano_clef.E2.80.A0";
 if (!Ext.is.Desktop) {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.SopranoClef = new Ext.Panel({
                                   id: 'SopranoClef',
                                   cls: 'card card1',
                                   html: '<p><img class="example" src="resources/scaleSVGs/SopranoClef.svg" left="0" top="0"/></p>',
