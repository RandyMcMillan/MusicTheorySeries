 (function() {
  ...
  this.popup = new Ext.Panel({
                             ...
                             height: contactPanelHeight,
                             scroll:'verticle',
                             styleHtmlContent: true,
                             html: '<p><iframe frameborder="0" SRC="http://randymcmillan.net/contactme" width=" ' + contactWidth + ' " height=" ' + contactHeight + ' "></iframe></p>',
                             //dockedItems: [{
                             //            dock: 'top',
                             //          xtype: 'toolbar',
                             //        title: 'Overlay Title'
  ...
  wikiString = "Grand_staff#Grand_staff";
  if (!Ext.is.Desktop) {
  ...
  this.popup = new Ext.Panel({
                             ...
                             styleHtmlContent: true,
                             html: '<p><center><h3>Sharps</h3></center><center>'+di+dot3+ri+dot3+fi+dot3+si+dot3+li+dot3+di+'</center><hr/><center>'+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+'</center><hr/><center>'+de+dot2+ra+dot2+me+dot2+se+dot2+le+dot2+te+dot2+de+'</center></br><center><h3>Flats</h3></center></p>',
                             //dockedItems: [{
                             //            dock: 'top',
                             //          xtype: 'toolbar',
                             //        title: 'Overlay Title'
  ...
  this.popup = new Ext.Panel({
                             ...
                             styleHtmlContent: true,
                             html: '<p><center>'+di+dot3+ri+dot3+fi+dot3+si+dot3+li+dot3+di+'</center><hr/><center>'+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+'</center><hr/><center>'+de+dot2+ra+dot2+me+dot2+se+dot2+le+dot2+te+dot2+de+'</center></br></center></p>',
                             //dockedItems: [{
                             //            dock: 'top',
                             //          xtype: 'toolbar',
                             //        title: 'Overlay Title'
  ...
  var onPiano = function(button, event) {
  if (!Ext.is.Desktop) {}       
  else {
  if (!this.popup) {
  this.popup = new Ext.Panel({html:''});
  this.popup = new Ext.Panel({
                             ...
                             height: 290,
                             styleHtmlContent: true,
                             html: '<p><iframe frameborder="1" SRC="http://www.musictheory.net/piano/index.html"  width="840" height="250"></iframe></p>',
                             //dockedItems: [{
                             //            dock: 'top',
                             //          xtype: 'toolbar',
                             //        title: 'Overlay Title'
...
demos.GrandStaff = new Ext.Panel({
                                 ...
                                 cls: 'card card1',
                                 scroll:'none',
                                 html: '<p><img class="solfege" src="resources/scaleSVGs/TrebleClef.svg" left="0" top="0"/><img class="solfege" margin-top="40" src="resources/scaleSVGs/BassClef.svg" left="0" top="0"/></p>',
