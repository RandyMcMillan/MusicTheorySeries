(function() {
 ...
 wikiString = "Clef#Mezzo-soprano_clef.E2.80.A0";
 if (!Ext.is.Desktop) {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+la+dot+ti+dot+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 demos.MezzoSopranoClef = new Ext.Panel({
                                   id: 'MezzoSopranoClef',
                                   cls: 'card card1',
                                   html: '<p><img class="example" src="resources/scaleSVGs/MezzoSopranoClef.svg" left="0" top="0"/></p>',
