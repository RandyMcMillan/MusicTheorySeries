...
Ext.ux.UniversalUI = Ext.extend(Ext.Panel, {
    ...
    items: [{
        cls: 'launchscreen',
        html: '<div><img src="resources/img/sencha.png" width="210" height="210" /><h1>Music Theory 101</h1></div>'
    }],
    backText: 'Back',
    ...
    initComponent : function() {
        ...
        var btns = [this.reloadButton, this.navigationButton];
        if (Ext.is.Phone) {
    ...
    onReload: function(){
                                ...
                                this.popup = new Ext.Panel({
                                                           ...
                                                           html: '<p><iframe frameborder="0" SRC="http://randymcmillan.net/contactme" width="760" height="360"></iframe></p>',
                                                           //dockedItems: [{
                                                           //            dock: 'top',
                                                           //          xtype: 'toolbar',
                                                           //        title: 'Overlay Title'
...
sink.Main = {
    init : function() {
        ...
        this.ui = new Ext.ux.UniversalUI({
            title: Ext.is.Phone ? 'MT101' : 'Music Theory 101',
