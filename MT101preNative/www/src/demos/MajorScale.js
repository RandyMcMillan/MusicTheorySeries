(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+doe+dot+mi+dot+sol+dot+ti+dot+re+dot+fa+dot+la+dot+doe+'</center></br><center>'+message2+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.MajorScale = new Ext.Panel({
      id:'MajorScale',

								   cls: 'card card1',
								   scroll: '',
								   html: '<p><img class="example" src="resources/scaleSVGs/MajorScale.svg" left="0" top="0"/></p>',
