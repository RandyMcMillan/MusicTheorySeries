(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center><h3>With Sharps</h3></center><center>'+doe+dot+re+dot+mi+dot+fi+dot+si+dot+li+dot+doe+'</center><hr/><center>'+doe+dot2+te+dot2+le+dot2+se+dot2+fe+dot2+re+dot2+doe+'</center></br><center><h3>With Flats</h3></center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.WholeToneScale = new Ext.Panel({
      id:'',

								   cls: 'card card1',
								   scroll: '',
								   html: '<p><img class="example" src="resources/scaleSVGs/WholeToneScaleFromC.svg" left="0" top="0"/></p>',
