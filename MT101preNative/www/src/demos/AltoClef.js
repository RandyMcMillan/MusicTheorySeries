(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+fa+dot+sol+dot+la+dot+doe+dot+re+dot+mi+dot+fa+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 demos.AltoClef = new Ext.Panel({
                                   id: 'AltoClef',
                                   cls: 'card card1',
                                   html: '<p><img class="example" src="resources/scaleSVGs/AltoClef.svg" left="0" top="0"/></p>',
