(function() {
 ...
 this.popup = new Ext.Panel({
                            ...
                            styleHtmlContent: true,
                            html: '<p><center>'+la+dot+ti+dot+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+'</center></br><center>'+message3+'</center></br><center>'+la+dot+sol+dot+fa+dot+mi+dot+re+dot+doe+dot+ti+dot+la+'</center></p>',
                            //dockedItems: [{
                            //            dock: 'top',
                            //          xtype: 'toolbar',
                            //        title: 'Overlay Title'
 ...
 var dockedItems = [new Ext.Toolbar({
  ...
  demos.Aeolian = new Ext.Panel({
                                id:'Aeolian',
								 cls: 'card card1',
								 scroll: '',
								 html: '<p><img class="example" src="resources/scaleSVGs/Aeolian.svg" left="0" top="0"/></p>',
