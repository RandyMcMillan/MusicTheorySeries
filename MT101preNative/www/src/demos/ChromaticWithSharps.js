 (function() {
  ...
  this.popup = new Ext.Panel({
                             ...
                             styleHtmlContent: true,
                             html: '<p><center><h3>Sharps</h3></center><center>'+di+dot2+ri+dot2+fi+dot2+si+dot2+li+dot2+ta+dot2+di+'</center><hr/><center>'+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+'</center><hr/><center>'+de+dot2+ra+dot2+me+dot2+se+dot2+le+dot2+te+dot2+de+'</center></br><center><h3>Flats</h3></center></p>',
                             //dockedItems: [{
                             //            dock: 'top',
                             //          xtype: 'toolbar',
                             //        title: 'Overlay Title'
  ...
  this.popup = new Ext.Panel({
                             ...
                             styleHtmlContent: true,
                             html: '<p><center><h2>Sharps</h2></center><center>'+di+dot2+ri+dot2+fi+dot2+si+dot2+li+dot2+ta+dot2+di+'</center><hr/><center>'+doe+dot+re+dot+mi+dot+fa+dot+sol+dot+la+dot+ti+dot+doe+'</center><hr/><center>'+de+dot2+ra+dot2+me+dot2+se+dot2+le+dot2+te+dot2+de+'</center></p>',
                             //dockedItems: [{
                             //            dock: 'top',
                             //          xtype: 'toolbar',
                             //        title: 'Overlay Title'
  ...
  demos.ChromaticWithSharps = new Ext.Panel({
                                        //id: 'ChromaticScales',
                                        cls: 'card card1',
                                        scroll:'none',
                                        html: '<p><img class="chromaticExample" src="resources/scaleSVGs/ChromaticWithSharps.svg" left="0" top="0"/><img class="chromaticExample" margin-top="40" src="resources/scaleSVGs/ChromaticWithFlats.svg" left="0" top="0"/></p>',
